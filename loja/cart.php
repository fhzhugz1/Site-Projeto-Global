  ...
  if ($_GET['action'] == 'remove'){
      foreach ($_SESSION['cart'] as $key => $value){
          if($value["product_id"] == $_GET['id']){
              ...
              echo "<script>alert('Produto foi removido.')</script>";
...
<body class="bg-light">
    ...
    <div class="row px-5">
                    ...
                    if (isset($_SESSION['cart'])){
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            foreach ($product_id as $id){
                                if ($row['id'] == $id){
                                    cartElement($row['product_image'], $row['product_name'],$row['product_price'], $row['id'], $row["product_info"]);
        ...
        <div class="col-md-4 offset-md-1 border rounded mt-5 bg-white h-25">
            ...
            <a href ="\Projeto GLOBAL\Pagamento\payplan\index.php">
            <button class="button">
